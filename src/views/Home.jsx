            ...
            <section className="home">
                <section className="hero">
                    <section className="top">
                        <h1>Hi, kyle!</h1>
                        <p>
                            Welcome back! Lorem ipsum dolor sit amet consectetur. Volutpat quis velit feugiat quis. Eget faucibus lacus cum massa faucibus pharetra fames. Tempor ridiculus dui sed convallis.
                        </p>
                    </section>
